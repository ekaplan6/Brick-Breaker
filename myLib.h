...
#define BRICKROWS 6
#define BRICKCOLS 8
#define NUMBRICKS ((BRICKROWS) * (BRICKCOLS))
#define BRICKWIDTH 30
#define BRICKHEIGHT 10

#define PLANKCOLOR WHITE
#define PLANKWIDTH 80
#define PLANKHEIGHT 10
#define PLANKROW 160 - PLANKHEIGHT -8
#define PLANKSPEED 7

#define BALLSIZE 5
#define BALLCOLOR GREY
#define BALLSPEED 2
